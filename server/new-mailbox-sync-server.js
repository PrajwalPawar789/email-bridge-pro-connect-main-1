...
if (!MAILBOX_OAUTH_SIMULATE && !GOOGLE_OAUTH_CLIENT_ID) {
  console.warn('[mailbox] GOOGLE_OAUTH_CLIENT_ID is missing. Gmail OAuth start will fail.');
}
if (!MAILBOX_OAUTH_SIMULATE && !GOOGLE_OAUTH_CLIENT_SECRET) {
  console.warn('[mailbox] GOOGLE_OAUTH_CLIENT_SECRET is missing. Gmail OAuth exchange will fail.');
}
if (!MAILBOX_OAUTH_SIMULATE && !MICROSOFT_OAUTH_CLIENT_ID) {
  console.warn('[mailbox] MICROSOFT_OAUTH_CLIENT_ID is missing. Outlook OAuth start will fail.');
}
if (!MAILBOX_OAUTH_SIMULATE && !MICROSOFT_OAUTH_CLIENT_SECRET) {
  console.warn('[mailbox] MICROSOFT_OAUTH_CLIENT_SECRET is missing. Outlook OAuth exchange will fail.');
}
